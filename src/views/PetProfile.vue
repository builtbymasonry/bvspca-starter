...
const textBannerData = {
  title: "Need more info on adopting or fostering?",
  text: "You’ve got questions and we’ve got you covered.",
  buttons: [
    { text: "Learn more about adoption" },
    { variant: "outline", text: "Learn more about fostering" }
  ]
};
