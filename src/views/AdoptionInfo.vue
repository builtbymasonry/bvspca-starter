    ...
    <div class="mx-auto max-w-5xl px-4">
      ...
      <div class="mb-10 md:mb-20 text-sm">
        ...
        <div
          ...
          :key="row.title"
          class="flex px-5 sm:px-10 lg:px-0 py-5 sm:py-3 odd:bg-gray-dark rounded lg:rounded-lg"
        >
          <div class="w-3/5 lg:w-[70%] lg:grid lg:grid-cols-2 lg:space-x-10 pr-12 sm:pr-0 lg:px-12">
            <h4 class="font-bold">{{ row.title }}</h4>
            <p v-if="row.description" class="mt-1 lg:mt-0 text-xs lg:text-sm leading-relaxed">{{ row.description }}</p>
          </div>
          <div class="w-2/5 lg:w-[30%] lg:pl-16 font-bold text-right lg:text-left">
            <div>{{ row.price }}</div>
      ...
      <div class="sm:mx-6 px-6 py-12 sm:p-14 lg:p-20 bg-white rounded-sm lg:rounded-lg shadow">
        <h2 class="mb-6 sm:mb-10 text-2xl md:text-3xl xl:text-5xl font-bold text-center">{{whatsIncludedCardData.title}}</h2>
        <List
          class="md:columns-2 lg:px-10 text-xs md:text-sm"
...
const faq = [
  {
    ...
    panel: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Egestas purus viverra accumsan in. Penatibus et magnis dis parturient. Dictum at tempor commodo ullamcorper a lacus."
  },
  {
    button: "Lorem ipsum dolor sit amet?",
    panel: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."
  },
  {
    button: "Lorem ipsum dolor sit amet consectetur?",
    panel: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Egestas purus viverra accumsan in. Penatibus et magnis dis parturient. Dictum at tempor commodo ullamcorper a lacus."
